          ...
          skills: [
            {
              ...
              questions: [
                ...
                { code: "ch1.placevalue.build.q3", kind: "BUILD_MODEL", stage: "CONCRETE", generatorId: "placevalue.build", params: {}, difficulty: 2 },
                { code: "ch1.placevalue.build.q4", kind: "WORD_PROBLEM", stage: "ABSTRACT", generatorId: "placevalue.riddle", params: {}, difficulty: 3 },
                { code: "ch1.placevalue.build.q5", kind: "BUILD_MODEL", stage: "CONCRETE", generatorId: "placevalue.build", params: {}, difficulty: 4 },
              ],
            },
          ],
        },
          ...
          skills: [
            {
              ...
              questions: [
                ...
                { code: "ch1.placevalue.decompose.q3", kind: "FILL_IN_BLANK", stage: "PICTORIAL", generatorId: "placevalue.decompose", params: {}, difficulty: 1 },
                { code: "ch1.placevalue.decompose.q4", kind: "FIND_THE_MISTAKE", stage: "ABSTRACT", generatorId: "placevalue.findmistake", params: {}, difficulty: 3 },
                { code: "ch1.placevalue.decompose.q5", kind: "FIND_THE_MISTAKE", stage: "ABSTRACT", generatorId: "placevalue.findmistake", params: {}, difficulty: 5 },
              ],
            },
          ],
        },
          ...
          skills: [
            {
              ...
              questions: [
                ...
                { code: "ch1.compare.q3", kind: "MULTIPLE_CHOICE", stage: "PICTORIAL", generatorId: "compare.numbers", params: {}, difficulty: 1 },
                { code: "ch1.compare.q4", kind: "MULTIPLE_CHOICE", stage: "ABSTRACT", generatorId: "compare.representations", params: {}, difficulty: 4 },
                { code: "ch1.compare.q5", kind: "FIND_THE_MISTAKE", stage: "ABSTRACT", generatorId: "compare.findmistake", params: {}, difficulty: 3 },
                { code: "ch1.compare.q6", kind: "MULTIPLE_CHOICE", stage: "ABSTRACT", generatorId: "compare.pickextreme", params: { mode: "greatest" }, difficulty: 4 },
                { code: "ch1.compare.q7", kind: "MULTIPLE_CHOICE", stage: "ABSTRACT", generatorId: "compare.pickextreme", params: { mode: "least" }, difficulty: 4 },
              ],
            },
          ],
        },
          ...
          skills: [
            {
              ...
              questions: [
                ...
                { code: "ch1.numberline.q3", kind: "NUMBER_LINE", stage: "PICTORIAL", generatorId: "numberline.place", params: {}, difficulty: 2 },
                { code: "ch1.numberline.q4", kind: "NUMBER_LINE", stage: "ABSTRACT", generatorId: "numberline.place", params: {}, difficulty: 5 },
              ],
            },
          ],
        },
          ...
          skills: [
            {
              ...
              questions: [
                ...
                { code: "ch1.order.q3", kind: "SORT_ORDER", stage: "ABSTRACT", generatorId: "order.numbers", params: {}, difficulty: 1 },
                { code: "ch1.order.q4", kind: "SORT_ORDER", stage: "ABSTRACT", generatorId: "order.numbers", params: {}, difficulty: 5 },
                { code: "ch1.order.q5", kind: "MULTIPLE_CHOICE", stage: "ABSTRACT", generatorId: "compare.pickextreme", params: { mode: "least" }, difficulty: 3 },
              ],
            },
          ],
        },
          ...
          skills: [
            {
              ...
              questions: [
                ...
                { code: "ch1.patterns.q3", kind: "FILL_IN_BLANK", stage: "PICTORIAL", generatorId: "pattern.skipcount", params: { step: 10 }, difficulty: 4 },
                { code: "ch1.patterns.q4", kind: "FIND_THE_MISTAKE", stage: "ABSTRACT", generatorId: "pattern.findmistake", params: { step: 10 }, difficulty: 3 },
                { code: "ch1.patterns.q5", kind: "FIND_THE_MISTAKE", stage: "ABSTRACT", generatorId: "pattern.findmistake", params: { step: 100 }, difficulty: 3 },
              ],
            },
          ],
        },
          ...
          skills: [
            {
              ...
              questions: [
                ...
                { code: "ch1.review.q5", kind: "FIND_THE_MISTAKE", stage: "ABSTRACT", generatorId: "compare.findmistake", params: {}, difficulty: 4 },
                { code: "ch1.review.q6", kind: "FILL_IN_BLANK", stage: "PICTORIAL", generatorId: "placevalue.decompose", params: {}, difficulty: 4 },
                { code: "ch1.review.q7", kind: "WORD_PROBLEM", stage: "ABSTRACT", generatorId: "placevalue.riddle", params: {}, difficulty: 3 },
                { code: "ch1.review.q8", kind: "MULTIPLE_CHOICE", stage: "ABSTRACT", generatorId: "compare.pickextreme", params: { mode: "greatest" }, difficulty: 4 },
              ],
            },
          ],
        },
